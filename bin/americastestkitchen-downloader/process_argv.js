...
if (argv_vals["--season"]) {
  if (argv_vals["--season"] < 1)
    argv_vals["--season"] = null
}
if (argv_vals["--episode"]) {
  if (!argv_vals["--season"] || (argv_vals["--episode"] < 1))
    argv_vals["--episode"] = null
}
...
else if (!argv_vals["--url"] && !argv_vals["--all"] && !argv_vals["--season"]) {
